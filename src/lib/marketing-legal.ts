...
export const PRIVACY_SECTIONS: { heading: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'The site records ordinary request logs and, through DataFast and Ahrefs, page views on sketchmason.com. If PostHog is configured, product events go there too. Errors may be sent to Sentry so a crash can be fixed.',
