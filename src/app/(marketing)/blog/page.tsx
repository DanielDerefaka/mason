...
/**
 * Sizes hint for the card covers: full column on mobile, half on tablet,
 * a third of the 1180px grid (minus two 28px gutters) on desktop.
 */
const COVER_SIZES =
  "(max-width: 750px) calc(100vw - 48px), (max-width: 1000px) calc(50vw - 62px), 375px";
